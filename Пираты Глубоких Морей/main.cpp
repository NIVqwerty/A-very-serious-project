...
void bar(int x, int y)
  ...
  txRectangle(x+-200-0,450,x+200-0,600);
    ...
    txDrawText(x+460-0,y+265-450,x+729-0,y+325-450, "Бар");
...
int main()
    ...
    Point(xPoint);
    txRectangle(0,0,800,600);
    Titrs(yTitrs,"Режиссёр Нещадим И.", 50);
    txEnd();
    xPoint +=1.5;
    txSleep(20);
    }
    ...
    Point(xPoint);
    txRectangle(0,0,800,600);
    Titrs(yTitrs,"Пираты Глубоких Морей", 60);
    txEnd();
    xPoint +=1.5;
    txSleep(20);
    }
    ...
    drawHome();
    Man(xMan,yMan,xLegs);
    text(500, 0, "Сценарист:Нещадим И.", 35);
    txEnd();
    xMan = xMan - 2;
    yMan = yMan + 2;
    ySun = ySun - 1;
    ...
    drawHome();
    Man(xMan,yMan,xLegs);
    text(0, 0, "Художник:Нещадим И.", 35);
    txEnd();
    yMan = yMan - 3;
    xSun = xSun + 3;
    xLegs = xLegs + 13;
    ...
    Man(xMan,yMan,xLegs);
    drawMapa(xMapa, yMapa);
    text(500, 0, "Аниматор:Нещадим И.", 35);
    txEnd();
    xMan = xMan + 4;
    xMapa = xMapa + 4;
    xSun = xSun + 3;
    ...
    table();
    Man(xMan,yMan,xLegs);
    Replic(410, 160, "Привет, слышал тебе нужен помощник", 25);
    txEnd();
    xPoint = xPoint + 1;
    txSleep(20);
    }
    ...
    table();
    Man(xMan,yMan,xLegs);
    Replic(410, 160, "Я помогу тебе, но за небольшой процент", 25);
    txEnd();
    xPoint = xPoint + 1;
    txSleep(20);
    }
 ...
 //На этом моменте я до конца определился с сюжетом :)
...
while (xMan>100)
    ...
    txSetFillColor(TX_BLACK);
    txRectangle(0,0,800,600);
    Titrs(0, "И пошли они на карабль", 60);
    txEnd();
    xPoint = xPoint +1;
    txSleep(20);
    }
    ...
    NPC(xNPS,yNPS,xLegsNps);
    Man(xMan,yMan,xLegs);
    Replic(290, 250, "Вот, это место!", 28);
    txEnd();
    xPoint = xPoint + 1;
    txSleep(20);
    }
    ...
    NPC(xNPS,yNPS,xLegsNps);
    Man(xMan,yMan,xLegs);
    Replic(290, 250, "Мы нашли его!", 28);
    txEnd();
    xPoint = xPoint + 1;
    txSleep(20);
    }
    ...
    txSetColor(TX_BLACK);
    txRectangle(0,0,800,600);
    Titrs(yTitrs-200,"А вот и всё", 65);
    Titrs(yTitrs+100,"Не плохая получилась история", 60);
    Titrs(yTitrs+400,"Интересная, весёлая,", 60);
    Titrs(yTitrs+800,"А самое главное,", 60);
    Titrs(yTitrs+1000,"У этой истории счастливый конец.", 60);
    Titrs(yTitrs+1500,"Конец.", 70);
    txEnd();
    yTitrs = yTitrs - 2;
    txSleep(20);
}
